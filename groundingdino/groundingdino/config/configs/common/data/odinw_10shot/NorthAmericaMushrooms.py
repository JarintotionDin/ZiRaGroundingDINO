...
if "NorthAmericaMushrooms_odinw_train" not in DatasetCatalog.list():
    register_coco_instances("NorthAmericaMushrooms_odinw_train", {},
                            "datasets/odinw/NorthAmericaMushrooms/North American Mushrooms.v1-416x416.coco/train/fewshot_train_shot10_seed3.json",
...
if "NorthAmericaMushrooms_odinw_test" not in DatasetCatalog.list():
    register_coco_instances("NorthAmericaMushrooms_odinw_test", {},
...
DatasetCatalog.get("NorthAmericaMushrooms_odinw_test")
test_thing_classes = MetadataCatalog.get("NorthAmericaMushrooms_odinw_test").thing_classes


dataloader.train = L(build_detection_train_loader)(
    dataset=L(get_detection_dataset_dicts)(names="NorthAmericaMushrooms_odinw_train"),
...
dataloader.test = L(build_detection_test_loader)(
    dataset=L(get_detection_dataset_dicts)(names="NorthAmericaMushrooms_odinw_test", filter_empty=False),
    mapper=L(DetrDatasetMapper)(
        augmentation=[
            L(T.ResizeShortestEdge)(
