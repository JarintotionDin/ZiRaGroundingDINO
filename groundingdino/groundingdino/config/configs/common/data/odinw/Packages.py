...
if "Packages_odinw_train" not in DatasetCatalog.list():
    register_coco_instances("Packages_odinw_train", {},
                            "datasets/odinw/Packages/augmented-v1/train/annotations_without_background.json",
                            "datasets/odinw/Packages/augmented-v1/train")
...
if "Packages_odinw_test" not in DatasetCatalog.list():
    register_coco_instances("Packages_odinw_test", {},
                            "datasets/odinw/Packages/augmented-v1/test/annotations_without_background.json",
                            "datasets/odinw/Packages/augmented-v1/test/")
