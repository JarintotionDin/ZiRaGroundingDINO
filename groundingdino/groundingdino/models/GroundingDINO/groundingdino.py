...
class GroundingDINO(nn.Module):
    ...
    def __init__(
        ...
        if use_prompt:
            self.prompt_adapter = MoeAdapter(embed_dim=self.bert.config.hidden_size,
                                    # down_dim=self.bert.config.hidden_size * 2,
                                    down_dim=prompt_middle_dim,
    ...
    def forward(self, samples: NestedTensor, targets: List = None, **kw):
        ...
        if self.use_prompt:
            adapter_output, adapter_loss_text = self.prompt_adapter(bert_output["last_hidden_state"])
        ...
        # print("text_token_mask:", text_token_mask)
        # import ipdb; ipdb.set_trace()
        ...
        hs, reference, hs_enc, ref_enc, init_box_proposal, _ = self.transformer(
...
def build_groundingdino(args):
    ...
    model = GroundingDINO(
        ...
        prompt_middle_dim=args.prompt_middle_dim,
    )
