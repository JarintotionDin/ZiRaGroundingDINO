...
from .base_criterion import box_cxcywh_to_xyxy, generalized_box_iou
from .base_criterion import get_world_size, is_dist_avail_and_initialized
...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes):
        ...
        # print(torch.max(torch.argmax(src_logits, dim=-1)),
        #       src_logits.shape,
        ...
        if self.loss_class_type == "ce_loss":
            ...
            # print(target_classes.unsqueeze(-1))
