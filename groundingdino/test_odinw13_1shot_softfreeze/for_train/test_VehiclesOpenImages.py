...
# get default config
iter_per_epoch = 20
dataloader = get_config("common/data/odinw_1shot/VehiclesOpenImages.py").dataloader
optimizer = get_config("common/optim.py").AdamW
lr_multiplier = modified_coco_scheduler(4, 2, base_steps=iter_per_epoch)
train = get_config("common/train.py").train

# modify training config
train.output_dir = "./output/odinw13_1shot/VehiclesOpenImages_cet"
...
optimizer.params.lr_factor_func = lambda module_name: 0.2 if "freeze" in module_name else 11
optimizer.lr = 0.001
