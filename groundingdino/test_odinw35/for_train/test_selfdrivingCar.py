...
# get default config
iter_per_epoch = int(23840 / 4)
dataloader = get_config("common/data/odinw/selfdrivingcar.py").dataloader
optimizer = get_config("common/optim.py").AdamW
lr_multiplier = modified_coco_scheduler(4, 2, base_steps=iter_per_epoch)
train = get_config("common/train.py").train

# modify training config
train.output_dir = "./output/odinw/selfdrivingCar_text_moe_adapter"
