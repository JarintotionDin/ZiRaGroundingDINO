...
def register_all_coco(root="datasets"):
    ...
    # register small meta datasets for incremental fine-tuning stage
    for prefix in ["novel"]:
        for shot in [1, 2, 3, 5, 10, 30]:
            for seed in range(10):
                seed = "" if seed == 0 else "_seed{}".format(seed)
                name = "coco_trainval_{}_all_{}shot{}".format(prefix, shot, seed)
                METASPLITS.append((name, "coco/trainval2014", ""))
...
register_coco_instances("mechmind_easy_10_15", {},
                        "datasets/mechmind_easy/mechmind_easy_10_15.json",
                        "datasets/mechmind_easy")
